...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/user/resetWithdrawPassword", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/user/resetPassword", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/user/resetWithdrawPassword", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/user/resetWithdrawPassword", V2: "POST"},
	}
	if err := db.Create(&entities).Error; err != nil {
		return ctx, errors.Wrap(err, "Casbin  ("+i.InitializerName()+") !")
	}
